...
public class SliderFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        painSB = (SeekBar) getView().findViewById(R.id.sb_pain);
        scoreTV = (TextView) getView().findViewById(R.id.tv_score);
        painSB.setMax(painMax);

        // On change listener.
        painSB.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {

            int progressChangedValue = 0;
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                progressChangedValue = progress;
                String value = "" + (painMin + progress * painStepSize);
